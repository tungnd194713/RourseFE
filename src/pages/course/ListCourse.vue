            ...
            <el-col :span="24">
                <el-card>
                    <div slot="header" class="clearfix">
                        <h2>Danh sách khóa học trong hệ thống</h2>
                        <el-button style="float: right;" type="primary" @click="openAddMentorDialog">Khóa học mới</el-button>
                    </div>
                    ...
                    <el-row :gutter="20" class="filters">
                        ...
                        <el-col :span="6">
                            <el-input v-model="filters.email" placeholder="Filter by tags"></el-input>
                        </el-col>
                        <el-col :span="6">
                            <el-button type="primary" @click="applyFilters">Lọc</el-button>
                            <el-button @click="resetFilters">Reset bộ lọc</el-button>
                        </el-col>
                    </el-row>
                    ...
                    <el-table :data="filteredMentors" style="width: 100%;">
                        ...
                        <el-table-column prop="title" label="Tên khóa học" width="180"></el-table-column>
                        <el-table-column label="Mục tiêu kỹ năng">
													<template slot-scope="scope">
                            ...
                            <template slot-scope="scope">
                                <span>{{ scope.row.point_cost }}</span>
                            </template>
                        </el-table-column>
