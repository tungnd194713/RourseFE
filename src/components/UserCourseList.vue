      ...
      <el-col :span="8" v-for="course in courses" :key="course.id">
        <el-card class="course-card">
          ...
          <div class="course-info">
            ...
            <p>Module completed: {{ course.moduled }} / {{ course.module }}</p>
            <p v-if="course.isCompleted" style="color: green; font-weight: bold">Completed</p>
            <p v-if="!course.isCompleted" style="color: red; font-weight: bold">In progress</p>
          </div>
        </el-card>
      </el-col>
    </el-row>
